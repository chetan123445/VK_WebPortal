...
import { useThread } from "../app/student/discussion/hooks/useThread";
import PostTree from "../app/student/discussion/components/PostTree";
import { useParams, useSearchParams } from "next/navigation";
import { addDiscussionPost, votePost, editDiscussionPost, deleteDiscussionPost, voteThread } from "../app/student/discussion/api/discussionApi";
import { DiscussionUser, DiscussionPost } from "../app/student/discussion/types";
...
const ThreadDetailContent: React.FC<{ userType?: string }> = ({ userType = 'Student' }) => {
