...
import { useThreads } from "../app/student/discussion/hooks/useThreads";
import { ChevronUp, ChevronDown, MessageSquare, Plus, Search, User, Users, Shield, GraduationCap } from "lucide-react";
import { createDiscussionThread, voteThread } from "../app/student/discussion/api/discussionApi";
import { logout, getUserData } from "../utils/auth.js";
...
const DiscussionPanel: React.FC<DiscussionPanelProps> = ({ userType = 'Student' }) => {
