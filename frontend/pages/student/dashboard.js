...
import { FaClipboardList, FaBookOpen, FaChartBar, FaBullhorn, FaCalendarAlt, FaEnvelope, FaLaptop, FaUser, FaBars, FaTimes } from "react-icons/fa";
import { BASE_API_URL } from '../apiurl.js';
import { getToken } from "../../utils/auth.js";

// Modern, collapsible sidebar for Student
function StudentSidebar({ userEmail, userPhoto, onMenuSelect, open, setOpen, selectedMenu }) {
  const menuItems = [
